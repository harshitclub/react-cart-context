      ...
      <div className="max-w-7xl mx-auto space-y-10 px-6">
        ...
        <section className="text-center">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            ...
            <strong>Context API</strong>, designed to offer a clean, scalable,
          ...
          <Card className="shadow-none rounded-sm">
            <CardContent className=" text-muted-foreground leading-relaxed">
              <p>
                ...
                optimized state management using the Context API, and smooth UI
                interactions powered by Tailwind CSS and Shadcn components.
              </p>
              <p className="mt-4">
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            <Card className="shadow-none rounded-sm gap-0">
              ...
              <CardContent className="text-muted-foreground">
                Manage cart items globally with Context API and maintain
